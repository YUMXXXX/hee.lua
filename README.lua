...
if game:GetService("CoreGui"):FindFirstChild("SwordHub Gui") then
    game:GetService("CoreGui"):FindFirstChild("SwordHub Gui"):Destroy()
end
...
local win = Flux:Window("SWORD HUB", "[ðŸŒŠ SEA 3] Blox Fruits", _G.Color1, _G.Color2, _G.ToggleKey)
